<h1 align="center">ĐỒNG HỒ GEORG JENSEN</h1>
<?php 
	include("dbconnect.php");
	$sql = "select * FROM tbl_nhasanxuat as n, tbl_sanpham as s WHERE (s.id_NSX=n.id_NSX) && (n.ten_NSX='Georg Jensen')&& (s.soluong>0) ";
